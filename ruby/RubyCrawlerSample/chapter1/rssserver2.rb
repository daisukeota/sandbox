...
def start_server
	...
	srv.mount('/test/rss.xml', RSSServlet, SbcrTopics, url:"http://crawler.sbcr.jp/samplepage.html", title:"WWW.SBCR.JP トピックス")
  srv.mount('/test2/rss.xml', RSSServlet, SbcrTopics, url:"http://crawler.sbcr.jp/samplepage.html", title:"WWW.SBCR.JP トピックス2")
